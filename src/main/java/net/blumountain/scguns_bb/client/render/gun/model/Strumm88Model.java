...
public class Strumm88Model implements IOverrideModel {
    ...
    public void render(float partialTicks, ItemDisplayContext transformType, ItemStack stack, ItemStack parent, LivingEntity entity, PoseStack matrixStack, MultiBufferSource buffer, int light, int overlay) {
        RenderUtil.renderModel(BBSpecialModels.STRUMM88_MAIN.getModel(), stack, matrixStack, buffer, light, overlay);
        if ((Gun.getScope(stack) == null))
            RenderUtil.renderModel(BBSpecialModels.STRUMM88_SIGHTS.getModel(), stack, matrixStack, buffer, light, overlay);
        else
            RenderUtil.renderModel(BBSpecialModels.STRUMM88_NO_SIGHTS.getModel(), stack, matrixStack, buffer, light, overlay);
        ...
        if (entity.equals(Minecraft.getInstance().player)) {
            ...
            RenderUtil.renderModel(BBSpecialModels.STRUMM88_BOLT.getModel(), stack, matrixStack, buffer, light, overlay);
            //Always pop
            matrixStack.popPose();
        }
    }
